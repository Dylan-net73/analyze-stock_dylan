            ...
            if 'Status Preço' in df_valuation.columns:
                ...
                for idx, (ticker_s, msg_s) in enumerate(todos_status):
                    with cols_status[idx % 4]:
                        if msg_s.startswith('✅'):
                            cor_bg, cor_borda = "#f0fff8", "#38a169"
                        elif msg_s.startswith('🔴'):
                            cor_bg, cor_borda = "#fff5f5", "#e53e3e"
                        else:
                            cor_bg, cor_borda = "#fffbf0", "#dd6b20"
                        ...
                        for col, op in zip(colunas, grupo):
                            ...
                            with col:
                                html_card = (
                                    ...
                                    "<div style='font-size:20px;font-weight:700;color:" + cor_borda + ";letter-spacing:0.5px;margin-bottom:10px;'>" + ticker_op + "</div>"
                                    "<div style='display:inline-block;background-color:" + cor_badge + ";color:white;border-radius:20px;padding:3px 14px;font-size:12px;font-weight:600;margin-bottom:14px;'>+"
                                    + f"{margem:.1f}" + "% margem</div>"
                                    "<div style='margin:6px 0;font-size:13px;color:#718096;'>"
                                    "<span style='font-weight:500;'>Preço Atual</span><br>"
                                    "<span style='font-size:17px;font-weight:700;color:#1a1f36;'>R$ " + f"{preco_atual:.2f}" + "</span></div>"
                                    "<div style='margin:8px 0 0 0;font-size:13px;color:#718096;'>"
                                    "<span style='font-weight:500;'>Preço Teto</span><br>"
                                    "<span style='font-size:17px;font-weight:700;color:" + cor_borda + ";'>R$ " + f"{preco_teto:.2f}" + "</span></div>"
                                    "</div>"
                                )

...
BRAPI_TOKEN = "iNWeatHaSGQDy8GiMdhabm"  # Token de acesso a API Brapi.dev
...
def _obter_lpa_vpa_brapi(ticker_symbol: str) -> Tuple[Optional[float], Optional[float]]:
    ...
    try:
        ...
        if resp.status_code == 429:
            ...
            # Registra flag global de limite atingido — lida pela interface para exibir aviso
            try:
                st.session_state['brapi_limite_atingido'] = True
            except Exception:
                pass  # session_state pode nao estar disponivel em contexto de thread
            return None, None
    ...
    if data_valuation:
        ...
        with tab2:
            ...
            for _, row in df_indicadores_filtrado.iterrows():
                ...
                roic_raw   = row.get('ROIC',      None)   # pode não existir no df
